INSERT INTO 'age_discount' ('id_age_discount', 'age_min', 'age_max', 'percentage', 'price_list_id_price_list')
VALUES (1, 0, 5, 100, 1);
INSERT INTO 'age_discount' ('id_age_discount', 'age_min', 'age_max', 'percentage', 'price_list_id_price_list')
VALUES (2, 6, 13, 50, 2);
INSERT INTO 'age_discount' ('id_age_discount', 'age_min', 'age_max', 'percentage', 'price_list_id_price_list')
...
INSERT INTO 'ski_lift_schedules' ('id_ski_lift_schedule', 'start_date', 'end_date', 'opens_time', 'closes_time', 'ski_lift_id_ski_left')
...
INSERT INTO 'time_passes' ('id_ski_lift', 'hours', 'price', 'price_list_id_price_list')
VALUES (1, 24, 600.0, 1);
INSERT INTO 'time_passes' ('id_ski_lift', 'hours', 'price', 'price_list_id_price_list')
VALUES (2, 16, 500.0, 1);
INSERT INTO 'time_passes' ('id_ski_lift', 'hours', 'price', 'price_list_id_price_list')
...
VALUES (1, 2, 1, '0000-00-00 00:06:00', 1);

INSERT INTO 'users' ('id_user', 'first_name', 'last_name', 'address', 'city', 'voivodeship', 'country', 'postal_code', 'phone', 'email', 'roles_id_role', 'password')
VALUES (1, 'Wiktoria', 'Fryta', 'Slowackiego 13', 'Katowice', 'Slaskie', 'Polska', '40-000', '123456789', 'WikiFryta22@interia.pl', 2, 'qwerty');
INSERT INTO 'users' ('id_user', 'first_name', 'last_name', 'address', 'city', 'voivodeship', 'country', 'postal_code', 'phone', 'email', 'roles_id_role', 'password')
VALUES (2, 'Marek', 'Pieczarek', 'Kebabowa 21', 'Katowice', 'Slaskie', 'Polska', '40-000', '987654321', 'PieczarekMarek1@interia.pl', 2, '123456');
INSERT INTO 'users' ('id_user', 'first_name', 'last_name', 'address', 'city', 'voivodeship', 'country', 'postal_code', 'phone', 'email', 'roles_id_role', 'password')
VALUES (3, 'Wiktoria', 'Fryta', 'Opolska 33', 'Katowice', 'Slaskie', 'Polska', '40-000', '555555555', 'AnkaSkakanka@interia.pl', 2, 'qwerty12');
INSERT INTO 'users' ('id_user', 'first_name', 'last_name', 'address', 'city', 'voivodeship', 'country', 'postal_code', 'phone', 'email', 'roles_id_role', 'password')
VALUES (4, 'Jan', 'Kowalski', 'Wojska Polskiego 13', 'Katowice', 'Slaskie', 'Polska', '40-000', '132123321', 'JanKowalski@interia.pl', 1, 'admin');
