...
ALTER TABLE passes ADD CONSTRAINT passes_pk PRIMARY KEY ( id_invoice_item );
...
ALTER TABLE reports ADD CONSTRAINT reports_pk PRIMARY KEY ( id_report );
...
ALTER TABLE age_discounts
    ADD CONSTRAINT age_discounts_price_list_fk FOREIGN KEY ( price_list_id_price_list )
        REFERENCES price_list ( id_price_list )
    NOT DEFERRABLE;
...
ALTER TABLE reports
    ADD CONSTRAINT reports_users_fk FOREIGN KEY ( users_id_user )
        REFERENCES users ( id_user )
    NOT DEFERRABLE;
...
ALTER TABLE usages
    ADD CONSTRAINT usages_passes_fk FOREIGN KEY ( passes_id_invoice_item )
        REFERENCES passes ( id_invoice_item )
    NOT DEFERRABLE;
